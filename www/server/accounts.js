...
if (Meteor.isServer) {
	Meteor.startup(function () { //When the server starts...
		console.log('CPX Server started!'); // Let's just write stuff, but that's not useful. Honestly
	});
	...
	Accounts.onCreateUser(function(options, user){
		...
		user.avatar = Meteor.call('getConfig').static_host + 'images/avatar.php?name=' + user.username;
		return user;
	});
